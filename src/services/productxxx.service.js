...
class ProductFactory {
    ...
    static registryProduct(type, classRef) {
...
// register
ProductFactory.registryProduct("Electronic", Electronic);
ProductFactory.registryProduct("Clothing", Clothing);
ProductFactory.registryProduct("Furniture", Furniture);
